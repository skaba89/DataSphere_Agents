  ...
  return (
    <div>
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 mb-8">
        ...
        <div className="flex gap-3">
          ...
          <button
            ...
            className="border border-red-300 text-red-600 dark:border-red-800 dark:text-red-400 px-4 py-2.5 rounded-lg font-medium hover:bg-red-50 dark:hover:bg-red-950/30 transition-colors"
          >
            Delete
          </button>
        </div>
      ...
      <div className="flex gap-2 mb-6 border-b border-border">
        {(['config', 'stats', 'conversations'] as const).map((tab) => (
          <button
            key={tab}
