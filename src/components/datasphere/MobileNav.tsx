    ...
    <nav className="fixed bottom-0 left-0 right-0 z-50 lg:hidden border-t bg-card/95 backdrop-blur-lg safe-area-bottom" aria-label="Navigation mobile">
      <div className="flex items-center justify-around h-16 px-1">
        ...
        >
          ...
          {['agents', 'marketplace', 'documents', 'payments', 'settings', 'templates', 'comparison', 'admin', 'billing', 'organizations', 'analytics', 'prompt-generator', 'saas-generator'].includes(currentView) && (
            <motion.div
